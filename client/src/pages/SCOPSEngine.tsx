...
const INITIAL_TEMPLATES: Template[] = [
  ...
  { id: 4, name: "Tour Confirmation", type: "SMS", description: "Remind buyers about scheduled tours", body: "Hi {buyerName}! Just confirming your home tour at {propertyAddress} tomorrow. Reply YES to confirm or call (775) 910-7771 to reschedule. – Apollo Home Builders", status: "Active" },
